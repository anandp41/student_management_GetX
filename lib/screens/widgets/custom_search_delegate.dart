...
import 'package:sql/screens/widgets/updater_bottom_sheet.dart';
...
class CustomSearchDelegate extends SearchDelegate {
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    for (Map<String, Object?> matchedWord
        in Get.find<DbListController>().dataListMap) {
                  ...
                  children: [
                    ...
                    Card(
                      ...
                      child: IconButton(
                          tooltip: 'Delete',
                          onPressed: () {
                            deleteRow(result['admno'] as String);
                          },
                          icon: const Icon(
                            Icons.delete,
                            color: Colors.red,
